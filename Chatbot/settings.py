...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # You can add your template folder path if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
connect(
    ...
    host=f"mongodb+srv://{config('MONGO_DB_USER')}:{config('MONGO_DB_PASSWORD')}@{config('MONGO_DB_CLUSTER')}/{config('MONGO_DB_NAME')}?retryWrites=true&w=majority"
)
